...
algo="rmappo"
exp="1122_render_formation_layered_3agents"
seed_max=1
...
do
    ...
    python render_formation_layered.py \
    --dis_factor 1 \
    --use_valuenorm \
    --save_gifs \
    --env_name ${env} \
    ...
    --episode_length 25 \
    --render_episodes 5 \
    --model_dir "/home/yanyz/data/gym-formation/train/mappo/results/MPE/formation_hd_env_layered/rmappo/1122_train_formation_layered_3agents/run3/models" \
