...
algo="rmappo"
exp="1123_render_formation_layered_share_3agents_dis_5e_2_A"
seed_max=1
...
do
    ...
    --episode_length 50 \
    --render_episodes 5 \
    --model_dir "/home/yanyz/data/gym-formation/train/mappo/results/MPE/formation_hd_env_layered/rmappo/1123_train_formation_layered_share_3agents_dis_5e_2_A/run2/models" \
