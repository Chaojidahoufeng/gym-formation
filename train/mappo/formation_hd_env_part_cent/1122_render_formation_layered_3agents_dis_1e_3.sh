...
algo="rmappo"
exp="1122_render_formation_layered_3agents_dis_1e_3"
seed_max=1
...
do
    ...
    --episode_length 25 \
    --render_episodes 5 \
    --model_dir "/home/yanyz/data/gym-formation/train/mappo/results/MPE/formation_hd_env_layered/rmappo/1122_train_formation_layered_3agents_dis_1e_3/run1/models" \
