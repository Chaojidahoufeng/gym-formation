...
class MultiAgentEnv(gym.Env):
    ...
    def __init__(self, world, reset_callback=None, reward_callback=None,
        ...
        self.num_agents_level_1 = world.num_agents_level_1
        self.num_agents_level_2 = world.num_agents_level_2
        # scenario callbacks
    ...
    def reset(self):
        ...
        obs_n_level_2 = []
        self.agents = self.world.policy_agents
        self.agents_level_1 = self.world.agents_level_1
        self.agents_level_2 = self.world.agents_level_2

        for agent in self.agents_level_1:
            obs_n_level_1.append(self._get_obs(agent))

        for agent_list in self.agents_level_2:
            for agent in agent_list:
                obs_n_level_2.append(self._get_obs(agent))
        return obs_n_level_1, obs_n_level_2
